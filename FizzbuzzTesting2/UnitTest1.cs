...
using System;
using FizzbuzzTesting2;


namespace FizzbuzzTesting2
{
    [TestClass]
    public class UnitTest1
    {
        [TestMethod]
        public void NegitiveListNumbersUpToOne()
        {
        ...
        [TestMethod]
        public void NegitiveListNumbersUpToTwo()
        {
            FizzBuzz fizzbuzz = new FizzBuzz();
            string result = fizzbuzz.Process(1);
            Assert.AreEqual("Buzz, Fizz", result);
        }
        [TestMethod]
        ...
        [TestMethod]
        public void ListNumbersUpToSix()
        {
            FizzBuzz fizzbuzz = new FizzBuzz();
            string result = fizzbuzz.Process(6);
            Assert.AreEqual("1, 2, Fizz, 4, Buzz, Fizz", result);
        }
        [TestMethod]
        public void ListNumbersUpToSeven()
        {
            FizzBuzz fizzbuzz = new FizzBuzz();
            string result = fizzbuzz.Process(7);
            Assert.AreEqual("1, 2, Fizz, 4, Buzz, 7", result);
        }
        [TestMethod]
        public void ListNumbersUpToEight()
        {
            FizzBuzz fizzbuzz = new FizzBuzz();
            string result = fizzbuzz.Process(8);
            Assert.AreEqual("1, 2, Fizz, 4, Buzz, 7, 8", result);
        }
        [TestMethod]
        public void ListNumbersUpToNine()
        {
            FizzBuzz fizzbuzz = new FizzBuzz();
            string result = fizzbuzz.Process(9);
            Assert.AreEqual("1, 2, Fizz, 4, Buzz, 7, 8, Fizz", result);
        }
        [TestMethod]
        public void ListNumbersUpToTen()
        {
            FizzBuzz fizzbuzz = new FizzBuzz();
            string result = fizzbuzz.Process(9);
            Assert.AreEqual("1, 2, Fizz, 4, Buzz, 7, 8, Fizz, Buzz", result);
        }
        ...
        [TestMethod]
        public void ListNumbersUpToFifty()
        {
            FizzBuzz fizzbuzz = new FizzBuzz();
            string result = fizzbuzz.Process(100);
            Assert.AreEqual("1, 2, Fizz, 4, Buzz, Fizz, 7, 8, Fizz, Buzz, 11, Fizz, 13, 14, FizzBuzz, 16, 17, Fizz, 19, Buzz, Fizz, 22, 23, Fizz, Buzz, 26, Fizz, 28, 29, FizzBuzz, 31, 32, Fizz, 34, Buzz, Fizz, 37, 38, Fizz, Buzz, 41, Fizz, 43, 44, FizzBuzz, 46, 47, Fizz, 49, Buzz", result);
        }
